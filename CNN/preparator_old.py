...
class Preparator:
    def __init__(self, result, x_train, y_train, x_valid, y_valid, times_valid, path, k, cw=None, name="", info=""):
        ...
        self.num_input_train_acc_x = self.height_train_acc_x = self.width_train_acc_x = self.num_input_train_acc_y = \
            ...
            self.width_train_acc_z = self.num_input_train_hr = self.height_train_hr = self.width_train_hr = \
            self.num_input_train_temp = self.height_train_temp = self.width_train_temp = self.num_input_valid_acc_x = \
            self.height_valid_acc_x = self.width_valid_acc_x = self.num_input_valid_acc_y = self.height_valid_acc_y = \
            self.width_valid_acc_y = self.num_input_valid_acc_z = self.height_valid_acc_z = self.width_valid_acc_z = \
