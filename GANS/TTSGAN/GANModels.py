...
class Generator(nn.Module):
    def __init__(self, seq_len=500, patch_size=50, channels=3, num_classes=9, latent_dim=100, embed_dim=10, depth=3,
...
class PatchEmbedding_Linear(nn.Module):
    ...
    def __init__(self, in_channels=3, patch_size=50, emb_size=10, seq_length=500):
        # self.patch_size = patch_size
        super().__init__()
